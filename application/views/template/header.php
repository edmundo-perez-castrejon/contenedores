...
<head>
   ...
   <!-- <style type='text/css'>
    ...
    <style type="text/css">
        ...
        .container {
            width: 962px; /* downsize our container to make the content feel a bit tighter and more cohesive. NOTE: this removes two full columns from the grid, meaning you only go to 14 columns and not 16. */
        }
